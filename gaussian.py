...
def mask_dominant_class(image, labels):
...
if __name__ == "__main__":
    ...
    mask, blur_image = mask_dominant_class(blur_image, labels)
    mask_2, blur_image_2 = mask_dominant_class(blur_image_2, labels_2)
